...
public class MyIterator<T> implements Iterator<T> {
    ...
    private DoubleNode<T> cursor;   // Puntero que avanza por la lista

    /**
     * Constructor del iterador.
     * Recibe el nodo inicial desde donde comenzará el recorrido.
     */
    public MyIterator(DoubleNode<T> cursor) {
        this.cursor = cursor;
    }
    ...
    // Al ser doble, podrías implementar métodos para ir hacia atrás
    public boolean hasPrevious() {

        return cursor != null && cursor.getPrevio() != null;
    }
}
