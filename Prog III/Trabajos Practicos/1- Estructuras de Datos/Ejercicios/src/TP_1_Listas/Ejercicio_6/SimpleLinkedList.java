...
public class SimpleLinkedList<T extends Comparable<T>> implements Iterable<T>{
    ...
    /**
     * Función que devuelve una nueva lista con los elementos que están
     * en lista1 pero NO están en lista2.
     *
    ...
    public static <T extends Comparable<T>> SimpleLinkedList<T> diferencia(
        ...
        while (actual != null) {
            ...
            // Si NO está en la segunda lista → lo agregamos
            if (lista2.indexOf(elem) == -1) {
                resultado.insertFront(elem);   // insertamos al frente
            }
